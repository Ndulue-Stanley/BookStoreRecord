...
class Link {
    public head: Noded | any | null
    public tail: Noded | any | null
...
// console.log(link.set(3, 22));
console.log(link.insert(5, 22));
// console.log(link.insert(0, 1));
console.log(link);


// console.log('remove', link.removeTail());
